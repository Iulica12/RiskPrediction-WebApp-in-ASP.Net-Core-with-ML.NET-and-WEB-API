...
namespace RiskPrediction
{
    ...
    {
        public const string RetrainConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\asus\Downloads\RestaurantScores.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features"}),labelColumnName:@"RiskCategory"))      
